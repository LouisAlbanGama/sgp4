...
pub fn iau_epoch_to_sidereal_time(epoch: f64) -> f64 {
    ...
    let theta_0 = (-6.2e-6 * c2000.powi(3)
    ...
    #[cfg(feature = "std")]
    {
        theta_0.rem_euclid(2.0 * core::f64::consts::PI)
    }
    #[cfg(not(feature = "std"))]
    {
        num_traits::Euclid::rem_euclid(&theta_0, &(2.0 * core::f64::consts::PI))
    }
}
...
pub fn afspc_epoch_to_sidereal_time(epoch: f64) -> f64 {
    ...
    let theta_0 = 1.7321343856509374
